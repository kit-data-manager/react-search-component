...
const Slider = React.forwardRef<React.ElementRef<typeof SliderPrimitive.Root>, React.ComponentPropsWithoutRef<typeof SliderPrimitive.Root>>(
    ({ className, ...props }, ref) => (
        ...
        >
            ...
            <SliderPrimitive.Thumb className="rfs:block rfs:h-5 rfs:w-5 rfs:rounded-full rfs:border-2 rfs:border-primary rfs:bg-background rfs:ring-offset-background rfs:transition-colors rfs:focus-visible:outline-hidden rfs:focus-visible:ring-2 rfs:focus-visible:ring-ring rfs:focus-visible:ring-offset-2 rfs:disabled:pointer-events-none rfs:disabled:opacity-50">
